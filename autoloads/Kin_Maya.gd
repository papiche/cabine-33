...
# Offsets cumulés par mois (calendrier grégorien non-bissextile).
# Note : le 29 février (année bissextile) n'est volontairement PAS compté dans ce
# calendrier Dreamspell — il est appelé "0 Hunab Ku" (Jour hors du Temps).
# Ne jamais "corriger" ce comportement : c'est la cosmologie Argüelles, pas un bug.
